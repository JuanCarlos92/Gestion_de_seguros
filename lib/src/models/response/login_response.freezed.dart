...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? push, String token, ClientResponse client});
...
class _$LoginResponseImpl implements _LoginResponse {
  const _$LoginResponseImpl(
      {required this.push, required this.token, required this.client});
  ...
  @override
  String toString() {
    return 'LoginResponse(push: $push, token: $token, client: $client)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, push, token, client);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final ClientResponse client}) = _$LoginResponseImpl;
